...
class ReactStepper extends React.Component{
    ...
    render(){
        return (
            <div class="numOfRoom">
                <ins className={this.state.subtractClassName +" SymbolMinus"} onClick={this.triggerClick.bind(this,'Subtract')}></ins>
                <ins>{this.props.value}</ins>
                <ins className={this.state.addClassName + " SymbolAdd"} onClick={this.triggerClick.bind(this,'Add')}></ins>
            </div>
        )
    }
}
